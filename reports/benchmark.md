...
- Average retrieval latency: **852.2 ms**
- Average token reduction vs full source context: **14.2%**

| Case | Layer | Pass | Latency ms | Retrieved tokens | Token reduction | Missing / Error |
| --- | --- | --- | ---: | ---: | ---: | --- |
| E01 | short_term | PASS | 0.0 | 133 | 0.0% |  |
| E06 | semantic | PASS | 529.4 | 148 | 67.8% |  |
| E09 | long_term | PASS | 1332.2 | 908 | 0.0% |  |
| E10 | short_term | PASS | 0.3 | 195 | 0.0% |  |
| E02 | long_term | PASS | 1381.3 | 1413 | 0.0% |  |
| E03 | long_term | PASS | 1554.5 | 1425 | 0.0% |  |
| E04 | episodic | PASS | 246.3 | 233 | 0.0% |  |
| E05 | episodic | PASS | 258.7 | 267 | 0.0% |  |
| E07 | mixed | PASS | 2109.6 | 485 | 14.2% |  |
| E11 | semantic | PASS | 268.3 | 146 | 74.2% |  |
| E08 | long_term | PASS | 1693.3 | 1412 | 0.0% |  |
...
`<USER_SUMMARY> For personal demos like ORCHID-27, the user prefers Python. However, for the company project BLUEBIRD-42, the backend must use TypeScript with NestJS, and Python is not permitted for this specific project. The user is debugging async HTTP for ORCHID-27, identifying connection churn as the main issue. They need to complete a benchmark report by Saturday at 16:00.  The user prefers Python for personal projects such as ORCHID-27 but must use TypeScript with NestJS for the company project BLUEBIRD-42. They dislike Java. The user needs to complete a benchmark report by Saturday at 16:00.  When explaining code, use short examples. The user is learning async/await and sometimes confu`
...
`<LONG_TERM> <USER_SUMMARY> For personal demos like ORCHID-27, the user prefers Python. However, for the company project BLUEBIRD-42, the backend must use TypeScript with NestJS, and Python is not permitted for this specific project. The user is debugging async HTTP for ORCHID-27, identifying connection churn as the main issue. They need to complete a benchmark report by Saturday at 16:00.  The user prefers Python for personal projects such as ORCHID-27 but must use TypeScript with NestJS for the company project BLUEBIRD-42. They dislike Java. The user needs to complete a benchmark report by Saturday at 16:00.  When explaining code, use short examples. The user is learning async/await and som`
